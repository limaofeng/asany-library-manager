...
import Sunmao, { SunmaoProvider, getMetadata, library, component, useReactComponent, useBlock } from '../src';
...
function TestSunmao() {
  const Component = useReactComponent('cn.asany.ui.sunmao.test.Dashboard', blocks);
